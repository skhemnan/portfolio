				...
				<div class="about-container">
					<div class="about-section">
						...
						{/* <p class="icon"><FiUserPlus/></p> */}
							...
							I'm a huge fan of lightweight and modular components with functional design in mind. I also enjoy writing automations and workflows with <a class="skill">Bash</a> and <a class="skill">Git</a> that make my job easier. I love working in a collaborative environment and believe in complete transparency and visbility in the workplace. 
						</p>
					</div>
					<div class='about-section'>
						<p class='about-text' id='about-work'>
							I'm currently a full stack software engineer at <a class="skill" href={'https://techcrunch.com/2021/02/03/gajigesa-a-fintech-startup-serving-underbanked-indonesian-workers-raises-2-5-million-seed-round/'}>GajiGesa</a>, a startup dedicated to bringing financial and employee wellness to 60% of Indonesia's workforce.
							...
							Prior to that, I worked as a data analyst at <a class="skill" href={'http://www.bitvore.com'}>Bitvore</a>, 
					...
					<div class='about-section'>
						<p class='about-text'>
							I attribute my acquired skillset to my curiosity to solve everyday problems. My personal project <a class="skill" href={'http://google.com'}>Filtable</a> (<a class="skill" href={'https://github.com/skhemnan/filtable'}>Repo</a>), 
							...
							{' '}to find and rank the top 10 movies that I've seen in my life, and <a class="skill" href={'http://skhemnan.github.io/visitr'}>Visitr</a> (<a class="skill" href={"https://github.com/skhemnan/visitr"}>Repo</a>) to quickly find out what I should pack in my suitcase based on my destination's weather. I'm always looking 
