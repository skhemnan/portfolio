	...
	<>
		...
		<AnimatePresence>
				<div class="about-container">
					...
					<div class='about-section'>
						<p class='about-text' style={{color: fade ? '#d9d9d9' : '#79776c'}}>
							For <Skill header text='Work'/>, I'm currently at <a class="skill" href={'https://techcrunch.com/2021/02/03/gajigesa-a-fintech-startup-serving-underbanked-indonesian-workers-raises-2-5-million-seed-round/'}>GajiGesa</a>, a startup aiming to bring <a class="skill">financial and employee wellness</a> to 60% of Indonesia's workforce.
							...
							{' '}As a software engineer, my tasks include but are not limited to building employer back end infrastructure for clients, 
							...
							I worked as a data analyst where I wrote server-side Javascript for collecting and analyzing customer data for sentiment analysis that influenced our machine learning model. This in turn increased productivity and efficiency of the sales and product team.
						</p>
					</div>
